...
/* package curried-in-space-0.1 */
#define VERSION_curried_in_space "0.1"
#define MIN_VERSION_curried_in_space(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package hakka-0.3.0 */
#define VERSION_hakka "0.3.0"
#define MIN_VERSION_hakka(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  3 || \
...
#define CURRENT_COMPONENT_ID "curried-in-space-0.1"

#define CURRENT_PACKAGE_KEY "curried-in-space-0.1"
