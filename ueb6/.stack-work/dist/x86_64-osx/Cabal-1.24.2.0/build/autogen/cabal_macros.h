...
/* package OT-0.1.0 */
#define VERSION_OT "0.1.0"
#define MIN_VERSION_OT(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "OT-0.1.0-1gqFYEXZiYEIActA72Dzk7"

#define CURRENT_PACKAGE_KEY "OT-0.1.0-1gqFYEXZiYEIActA72Dzk7"
